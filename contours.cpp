...
{
	// Read input image
	cv::Mat image= cv::imread("./road.jpeg",0);
	if (!image.data)
		return 0; 
	...
	cv::line(test,cv::Point(100,0),cv::Point(200,200),cv::Scalar(200,0,0));
	cv::line(test,cv::Point(0,50),cv::Point(200,200),cv::Scalar(200,0,0));
	cv::line(test,cv::Point(0,200),cv::Point(200,0),cv::Scalar(200,0,0));
	cv::line(test,cv::Point(200,0),cv::Point(0,200),cv::Scalar(200,0,0));
	cv::line(test,cv::Point(100,0),cv::Point(100,200),cv::Scalar(200,0,0));
	cv::line(test,cv::Point(0,100),cv::Point(200,100),cv::Scalar(200,0,0));
